...
import id.samai.mymedcure.activities.tab_details_2
...
class afternoonadapter  (val context: Context, private val schedules: ArrayList<medic>) : RecyclerView.Adapter<afternoonadapter.ViewHolder>() {
    ...
    open inner class ViewHolder(private val view: View) : RecyclerView.ViewHolder(view){
        ...
        fun bind(schedule: medic) {
            ...
            view.percent.setImageResource(R.drawable.wrong4)
            if(!todaystat.isEmpty()) {
                if (todaystat.get(0).afternoon == 1) {
                ...
                view.setOnClickListener {
                    Intent(it.context, tab_details_2_java::class.java).apply {
                        val bundle = Bundle().apply {
                            ...
                            putExtra("update_info","afternoon")
